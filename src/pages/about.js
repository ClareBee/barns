...
const About = props => (
  <React.Fragment>
    ...
    <p>This site is best viewed on up-to-date browsers: <a href="https://www.whatismybrowser.com/" target="_blank" rel="noopener noreferrer">www.whatismybrowser.com</a></p>
    <Divider />
...
    />
    ...
    <Section id="project">
      ...
      <p>
         Field barns - also known as <strong>laithes</strong> - are unusual in being located far from other farm buildings, making them a distinctive feature of the Dales landscape. Darkened slate roofs in the rain, limestone walls bleached light in sunshine, their very presence seems attuned with the weather, somewhere mid-way between man-made and organic.
      </p>
      <p>
